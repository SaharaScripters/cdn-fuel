...
RegisterNetEvent("cdn-fuel:server:electric:OpenMenu", function(amount, inGasStation, hasWeapon, purchasetype, FuelPrice)
	...
	if not amount then if Config.FuelDebug then print("Electric Recharge Amount is invalid!") end exports.qbx_core:Notify(src, Lang:t("electric_more_than_zero"), 'error') return end
	Wait(50)
